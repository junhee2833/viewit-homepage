...
export default function ContactForm() {
  ...
  return (
    <>
      <section className="w-full bg-[#353535] text-white py-16 px-6 sm:px-4 flex flex-col items-center justify-center">
        <div className="max-w-6xl w-full mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          {/* 우측 입력 폼 */}
          <form className="bg-transparent flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <label htmlFor="privacy" className="text-xs select-none">
                문의에 대한 답변을 받기 위해 <button type="button" onClick={() => setShowPrivacyModal(true)} className="text-purple-300 underline">개인정보 취급방침</button>에 동의합니다.
              </label>
            </div>
            <button 
              type="submit" 
              disabled={isSubmitting}
              className="mt-4 bg-[#e07a3a] hover:bg-[#d96a22] disabled:bg-gray-400 text-white font-semibold rounded w-full py-3 text-lg transition-colors"
            >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-md w-full p-6 relative">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-xl font-bold text-gray-900">개인정보 취급방침</h3>
              <button
            ...
            <div className="text-gray-700 mb-6 max-h-96 overflow-y-auto">
              <div dangerouslySetInnerHTML={{
                __html: `
                  <p>VIEWIT(이하 '회사'라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립, 공개합니다.</p>
                  
                  <p><strong>제1조 (개인정보의 처리목적)</strong><br>
                  회사는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 개인정보보호법 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.</p>
                  ...
                  <p><strong>제2조 (개인정보의 처리 및 보유기간)</strong><br>
                  ...
                  <p><strong>제4조(개인정보의 파기)</strong><br>
                  ...
                  <p><strong>제5조(개인정보의 안전성 확보조치)</strong><br>
                  ...
                  <p><strong>제6조(개인정보 자동 수집 장치의 설치∙운영 및 거부에 관한 사항)</strong><br>
                  ...
                  ③ 정보주체는 웹 브라우저 옵션 설정을 통해 쿠키 허용, 차단 등의 설정을 할 수 있습니다. 다만, 쿠키 저장을 거부할 경우 맞춤형 서비스 이용에 어려움이 발생할 수 있습니다.</p>
                  
                  <p>▶ 웹 브라우저에서 쿠키 허용/차단<br>
                  - 크롬(Chrome) : 웹 브라우저 설정 > 개인정보 보호 및 보안 > 인터넷 사용기록 삭제<br>
                  - 엣지(Edge) : 웹 브라우저 설정 > 쿠키 및 사이트 권한 > 쿠키 및 사이트 데이터 관리 및 삭제</p>
                  
                  <p>▶ 모바일 브라우저에서 쿠키 허용/차단<br>
                  ...
                  <p><strong>제7조(개인정보 보호책임자)</strong><br>
                  ① 회사는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만 처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.</p>
                  
                  <p>▶ 개인정보 보호책임자<br>
                  성명 : 오수빈<br>
                  직책 : 대표<br>
                  연락처 : subin@viewitcorp.com<br>
                  ※ 개인정보 보호 담당부서로 연결됩니다.</p>
                  
                  <p>▶ 개인정보 보호 담당부서<br>
                  부서명 : 기획팀<br>
                  연락처 : subin@viewitcorp.com</p>
                  
                  <p>② 정보주체께서는 회사의 서비스(또는 사업)를 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만 처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 회사는 정보주체의 문의에 대해 지체없이 답변 및 처리해드릴 것입니다.</p>
                  
                  <p><strong>제8조(개인정보 열람청구)</strong><br>
                  정보주체는 개인정보 보호법 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수 있습니다. 회사는 정보주체의 개인정보 열람 청구가 신속하게 처리되도록 노력하겠습니다.</p>
                  
                  <p>▶ 개인정보 열람청구 접수․처리 부서<br>
                  부서명 : 기획팀<br>
                  연락처 : subin@viewitcorp.com</p>
                  
                  <p><strong>제9조(권익침해 구제 방법)</strong><br>
                  ...
                  <p><strong>제10조(개인정보 처리방침 시행 및 변경)</strong><br>
                  이 개인정보 처리방침은 2025. 1. 1. 부터 적용됩니다.</p>
                `
              }} />
            </div>
